...
export function Hero() {
  return (
    <div className="flex h-screen w-full flex-col space-y-8 px-72 py-20">
      ...
      <div className="w-9/12 gap-2 text-pretty xl:flex-col">
        <p className="text-lg">
          O MIDAS tem a finalidade de auxiliar no gerenciamento da sua empresa.
          Você terá total controle gerencial, facilitando a venda e gerando mais
          lucros.
        </p>
      </div>
