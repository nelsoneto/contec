...
export function Body() {
  return (
    <div className="h-auto bg-slate-900">
      <div className="flex h-full w-full flex-col items-center space-y-2 bg-pattern bg-center bg-no-repeat px-6 py-8 xl:px-80 xl:py-10">
