export function Header() {
  return (
    <section className="bg-slate-900 bg-custom-image bg-cover bg-center p-32 px-6 xl:px-72 xl:py-64">
      <div className="grid w-full grid-cols-2 items-center justify-center gap-7 rounded-lg px-4 py-4">
        <div className="flex flex-col items-center justify-center gap-10 rounded-lg px-1 py-1 text-left">
