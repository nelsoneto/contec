...
export default function Home() {
  ...
  return (
    <section className="flex items-center justify-center h-[100vh]">
      <div className="flex flex-col items-center lg:w-96 sm:w-auto">
        <div className="p-4 text-white font-extrabold text-[25px]">
          <h2>Ticket Contec</h2>
        </div>
        <form
          action=""
        ...
        >
          ...
          <button
            type="submit"
            className="bg-blue-800 houver: p-[10px] text-gray-50 font-medium rounded"
          >
            Fazer Login
          </button>
          ...
          <button
            ...
            type="button"
            className="justify-center text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2"
          >
            <svg
